 ...
 */
   ...
   async function main() {
     ...
     const permissionsData = [
       ...
       { nom: "Voir les niveaux", code: "NIVEAUX_VIEW", description: "Consulter les niveaux"},
       { nom: "Gérer les niveaux", code: "NIVEAUX_MANAGE", description: "Créer, modifier ou supprimer les niveaux" },
     ...
     //ASSOCIATION RÔLES et PERMISSIONS
